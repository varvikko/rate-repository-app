...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
        it('renders repository information correctly', () => {
            ...
            const elem = repositories.edges[0].node;

            expect(getAllByTestId('fullname')[0]).toHaveTextContent(elem.fullName);
            expect(getAllByTestId('description')[0]).toHaveTextContent(elem.description);
            expect(getAllByTestId('language')[0]).toHaveTextContent(elem.language);
